...
export const translations: { [lang: string]: Translation } = {
  en: {
    ...
    industries: {
      ...
      waterTreatmentFull: "Water & Wastewater Treatment Solutions",
      waterTreatmentDesc: "Advanced automation solutions for water and wastewater treatment facilities, ensuring efficient operations, regulatory compliance, and optimal resource utilization. Our systems provide real-time monitoring and control of critical processes.",
      processControlSystems: "Process Control Systems",
      processControlSystemsDesc: "Automated control of filtration, chemical dosing, and treatment processes",
      scadaIntegration: "SCADA Integration",
      scadaIntegrationDesc: "Centralized monitoring and control of multiple treatment facilities",
      complianceReporting: "Compliance Reporting",
      complianceReportingDesc: "Automated data collection and reporting for regulatory compliance",
      ...
      pulpPaperFull: "Pulp & Paper Manufacturing Solutions",
      pulpPaperDesc: "Comprehensive automation solutions for pulp and paper production facilities, from wood preparation to final product packaging. Our systems optimize production efficiency, quality control, and resource utilization while ensuring environmental compliance.",
      productionOptimization: "Production Optimization",
      productionOptimizationDesc: "Maximizing throughput while maintaining quality standards",
      processControl: "Process Control",
      processControlDesc: "Temperature, pressure, and flow control systems",
      environmentalControls: "Environmental Controls",
      environmentalControlsDesc: "Emission monitoring and waste reduction systems",
      ...
      // Metal Industry
      metalIndustryFull: "Metal Processing & Manufacturing Solutions",
      metalIndustryDesc: "Advanced automation solutions for steel, aluminum, and metal processing operations. Our systems enhance precision, safety, and productivity across all stages of metal manufacturing from smelting to finishing.",
      smeltingRefining: "Smelting & Refining",
      smeltingRefiningDesc: "Precision temperature control and safety systems for furnace operations",
      rollingForming: "Rolling & Forming",
      rollingFormingDesc: "Advanced positioning and synchronization for metal forming processes",
      cuttingFinishing: "Cutting & Finishing",
      cuttingFinishingDesc: "Precision cutting, surface treatment, and quality control automation",
      furnaceTempControl: "Furnace Control",
      rollGapPositioning: "Rolling Mills",
      precisionCutting: "Precision Cutting",
      qualityInspection: "Quality Inspection",
      
      // Mining Industry
      miningFull: "Mining & Mineral Processing",
      miningDesc: "Robust automation systems designed for harsh mining environments, from extraction to processing. Our solutions enhance safety, productivity, and operational efficiency while meeting stringent environmental and safety standards.",
      safetySystems: "Safety Systems",
      ...
      extractionTransportDesc: "Conveyor systems, crushers, and material handling automation",
      processingRefining: "Processing & Refining",
      processingRefiningDesc: "Flotation, grinding, and separation process control",
      environmentalControl: "Environmental Control",
      environmentalControlDesc: "Dust suppression, water treatment, and waste management",
      
      // Additional Industries
      additionalIndustries: "Additional Industries",
      additionalIndustriesDesc: "Expanding our expertise across diverse industrial sectors",
      processPlantsFull: "Chemical, food, and pharmaceutical processing automation",
      ...
      consumerGoodsFull: "Manufacturing machinery automation for consumer products",
      ...
      whyChooseUsDesc: "Proven expertise and results across all industrial sectors",
      certifiedExpertise: "Certified Expertise",
      certifiedExpertiseDesc: "Rockwell Automation Silver System Integrator with proven industry knowledge",
      experiencedTeam: "Experienced Team",
      experiencedTeamDesc: "30+ professionals with deep understanding of industrial processes",
      longTermPartnership: "Long-term Partnership",
      longTermPartnershipDesc: "Committed to ongoing support and system optimization",
      
      // CTA
      readyToAutomate: "Ready to Automate Your Industry?",
      readyToAutomateDesc: "Contact our industry experts to discuss your specific automation requirements",
  ...
  id: {
    ...
    industries: {
      ...
      // Water Treatment Industry
      waterTreatmentFull: "Solusi Pengolahan Air & Air Limbah",
      waterTreatmentDesc: "Solusi otomasi canggih untuk fasilitas pengolahan air dan air limbah, memastikan operasi yang efisien, kepatuhan regulasi, dan pemanfaatan sumber daya yang optimal. Sistem kami menyediakan pemantauan dan kontrol real-time dari proses kritis.",
      processControlSystems: "Sistem Kontrol Proses",
      processControlSystemsDesc: "Kontrol otomatis filtrasi, dosis kimia, dan proses pengolahan",
      scadaIntegration: "Integrasi SCADA",
      scadaIntegrationDesc: "Pemantauan dan kontrol terpusat dari beberapa fasilitas pengolahan",
      complianceReporting: "Pelaporan Kepatuhan",
      complianceReportingDesc: "Pengumpulan data otomatis dan pelaporan untuk kepatuhan regulasi",
      ...
      // Pulp and Paper Industry
      pulpPaperFull: "Solusi Manufaktur Pulp & Kertas",
      pulpPaperDesc: "Solusi otomasi komprehensif untuk fasilitas produksi pulp dan kertas, dari persiapan kayu hingga pengemasan produk akhir. Sistem kami mengoptimalkan efisiensi produksi, kontrol kualitas, dan pemanfaatan sumber daya sambil memastikan kepatuhan lingkungan.",
      productionOptimization: "Optimisasi Produksi",
      productionOptimizationDesc: "Memaksimalkan throughput sambil mempertahankan standar kualitas",
      processControl: "Kontrol Proses",
      processControlDesc: "Sistem kontrol suhu, tekanan, dan aliran",
      environmentalControls: "Kontrol Lingkungan",
      environmentalControlsDesc: "Pemantauan emisi dan sistem pengurangan limbah",
      ...
      // Metal Industry
      metalIndustryFull: "Solusi Pemrosesan & Manufaktur Logam",
      metalIndustryDesc: "Solusi otomasi canggih untuk operasi pemrosesan baja, aluminium, dan logam. Sistem kami meningkatkan presisi, keselamatan, dan produktivitas di semua tahap manufaktur logam dari peleburan hingga finishing.",
      smeltingRefining: "Peleburan & Pemurnian",
      smeltingRefiningDesc: "Kontrol suhu presisi dan sistem keselamatan untuk operasi tungku",
      rollingForming: "Rolling & Forming",
      rollingFormingDesc: "Positioning dan sinkronisasi canggih untuk proses pembentukan logam",
      cuttingFinishing: "Pemotongan & Finishing",
      cuttingFinishingDesc: "Pemotongan presisi, perlakuan permukaan, dan otomasi kontrol kualitas",
      furnaceTempControl: "Kontrol Tungku",
      rollGapPositioning: "Rolling Mills",
      precisionCutting: "Pemotongan Presisi",
      qualityInspection: "Inspeksi Kualitas",
      
      // Mining Industry
      miningFull: "Pertambangan & Pemrosesan Mineral",
      miningDesc: "Sistem otomasi tangguh yang dirancang untuk lingkungan pertambangan yang keras, dari ekstraksi hingga pemrosesan. Solusi kami meningkatkan keselamatan, produktivitas, dan efisiensi operasional sambil memenuhi standar lingkungan dan keselamatan yang ketat.",
      safetySystems: "Sistem Keselamatan",
      safetySystemsDesc: "Pemantauan keselamatan dan sistem shutdown darurat yang canggih",
      crushingGrinding: "Crushing & Grinding",
      separationSystems: "Sistem Pemisahan",
      dewatering: "Dewatering",
      processMonitoring: "Pemantauan Proses",
      processMonitoringDesc: "Pemantauan dan optimisasi real-time dari pemrosesan mineral",
      miningApplications: "Aplikasi Pertambangan",
      materialHandlingMiningDesc: "Sistem konveyor dan transportasi material otomatis",
      extractionTransport: "Ekstraksi & Transportasi",
      extractionTransportDesc: "Sistem konveyor, crusher, dan otomasi material handling",
      processingRefining: "Pemrosesan & Pemurnian",
      processingRefiningDesc: "Flotasi, grinding, dan kontrol proses pemisahan",
      environmentalControl: "Kontrol Lingkungan",
      environmentalControlDesc: "Penekanan debu, pengolahan air, dan manajemen limbah",
      
      // Additional Industries
      additionalIndustries: "Industri Tambahan",
      additionalIndustriesDesc: "Memperluas keahlian kami di berbagai sektor industri",
      ...
      conveyorSystems: "Sistem konveyor",
      sortingRouting: "Sorting dan routing",
      ...
      webTension: "Kontrol web tension",
      ...
      whyChooseUsDesc: "Keahlian dan hasil yang terbukti di semua sektor industri",
      certifiedExpertise: "Keahlian Bersertifikat",
      certifiedExpertiseDesc: "Rockwell Automation Silver System Integrator dengan pengetahuan industri yang terbukti",
      experiencedTeam: "Tim Berpengalaman",
      experiencedTeamDesc: "30+ profesional dengan pemahaman mendalam tentang proses industri",
      longTermPartnership: "Kemitraan Jangka Panjang",
      longTermPartnershipDesc: "Berkomitmen untuk dukungan berkelanjutan dan optimisasi sistem",
      
      // CTA
      readyToAutomate: "Siap Mengotomatisasi Industri Anda?",
      readyToAutomateDesc: "Hubungi ahli industri kami untuk mendiskusikan kebutuhan otomasi spesifik Anda",
