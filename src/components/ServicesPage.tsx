            ...
            <div className="relative group">
              ...
              <div className="relative bg-gradient-to-br from-white/95 via-white/90 to-white/95 backdrop-blur-xl rounded-3xl p-12 lg:p-16 border border-gray-200/50 shadow-2xl">
                ...
                <div className="relative z-10 text-center">
                  ...
                  >
                    <span className="block mb-2">Ready to Start Your</span>
                  ...
                  <div className="flex flex-col sm:flex-row gap-5 justify-center items-center">
                    ...
                    >
                      ...
                      <span
                        ...
                        data-translate="servicesPage.ctaConsultation"
                      >
                    ...
                    >
                      {/* Animated Icon Container */}
                      <div className="relative z-10 mr-3 w-6 h-6 flex items-center justify-center">
                        <i className="fas fa-cube transform group-hover/btn:rotate-180 transition-all duration-500"></i>
                      </div>

                      <span
                        className="relative z-10"
                        data-translate="servicesPage.ctaProducts"
                      >
                        View Our Products
                      </span>
